...
function(ggml_cuda_fattn_vec_instances DIR OUT_SRCS)
    ...
    # TurboQuant KV cache combinations are always compiled, they are not selectable via GGML_CUDA_FA_QUANTS
    set(FA_TURBO_TYPES turbo2_0 turbo3_0 turbo4_0)
    set(FA_TURBO_COMBINATIONS "")
    foreach (TYPE_V IN LISTS FA_TURBO_TYPES)
        foreach (TYPE_K IN LISTS FA_TURBO_TYPES)
            list(APPEND FA_TURBO_COMBINATIONS ${TYPE_K}-${TYPE_V})
        endforeach()
        list(APPEND FA_TURBO_COMBINATIONS q8_0-${TYPE_V} ${TYPE_V}-q8_0)
    endforeach()
    foreach (COMBINATION IN LISTS FA_TURBO_COMBINATIONS)
        string(REPLACE "-" ";" COMBINATION_KV "${COMBINATION}")
        list(GET COMBINATION_KV 0 TYPE_K)
        list(GET COMBINATION_KV 1 TYPE_V)
        string(TOUPPER "GGML_CUDA_FA_${TYPE_K}_${TYPE_V}" COMBINATION_DEF)
